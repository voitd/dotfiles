...
_G.packer_plugins = {
  ...
  ["cmp-fuzzy-buffer"] = {
    loaded = true,
    path = "/Users/void/.local/share/nvim/site/pack/packer/start/cmp-fuzzy-buffer",
    url = "https://github.com/tzachar/cmp-fuzzy-buffer"
  },
  ["cmp-fuzzy-path"] = {
    loaded = true,
    path = "/Users/void/.local/share/nvim/site/pack/packer/start/cmp-fuzzy-path",
  ...
  ["fuzzy.nvim"] = {
    loaded = true,
    path = "/Users/void/.local/share/nvim/site/pack/packer/start/fuzzy.nvim",
